...
def show_persistence_calculation_window(data_type):
    """
    Display an informational window while the persistence
    diagram is being calculated.
    """
    ...
    root.title("Persistence Calculation")
    ...
    # Using place() makes it very easy to center the
    # entire content block in this simple window.
    main_frame.place(
        relx=0.5,
        rely=0.5,
        anchor="center",
    ...
    ttk.Label(
        main_frame,
        text="Computing Persistence Diagram",
        font=(
            "TkDefaultFont",
            TITLE_FONT_SIZE,
            "bold",
    ...
    ttk.Label(
        main_frame,
        text=(
            f"Computing the persistence diagram for {data_type} dataset.\n\n"
...
def select_Adamapper_parameters_interactively(
    ...
    """
    Open an interactive window for selecting AdaMapper parameters.
    ...
    # Network datasets have restricted parameter choices.
    ...
    # Closing the window using X is treated as Quit Program.
    decision = {
        "action": "quit",
        "parameters": None,
    }
    ...
    # ==================================================
    # 4. VALUES CONNECTED TO GUI CONTROLS
    # ==================================================
    ...
    title_label = ttk.Label(
        main_frame,
        text=(
            f"Select AdaMapper Parameters "
            f"for {data_type} Dataset"
        ),
        font=(
            "TkDefaultFont",
            15,
    ...
    # ==================================================
    # 14. RESTORE RECOMMENDED DEFAULTS
    # ==================================================

    def restore_defaults():
        """
        Restore the recommended values without closing
    ...
    if dataset_type == "network":
        ...
        note_title_text = "Please note:"

        note_message = (
            "Network datasets use only the "
            "base_point_geodesic_distance filter. Available base-point methods are EP and BC."
        )
        ...
        note_message = (
            ...
            "base-point method (EP, DR, or BC). For all other filter functions, select None."
        )
    ...
    # ==================================================
    # 16. VALIDATE AND ACCEPT PARAMETERS
    # ==================================================

    def run_with_parameters():
        """
        Validate the displayed values and close the
        window when all values are valid.
        """
        ...
        if (
            ...
            messagebox.showerror(
                ...
                "Please select a filter function "
        ...
        if (
            ...
            messagebox.showerror(
                ...
                "Please select a base-point method "
                "from the available list.",
                parent=root,
            )
        ...
        if (
            ...
            if dataset_type == "network":
                ...
                base_point_message = (
                    "The base_point_geodesic_distance "
                    "filter requires a base-point method. "
                    "Please select EP or BC."
                )
    ...
    # Wait until the user selects an action.
    root.mainloop()
...
def select_mapper_parameters_interactively(
    ...
    title_label = ttk.Label(
        main_frame,
        text=(
            f"Select standard Mapper Parameters "
            f"for {data_type} Dataset"
        ),
        font=(
            "TkDefaultFont",
    ...
    if round_number == 1:
        ...
        instruction_message = (
            ...
            "You may change any value before running."
        )

    else:

        instruction_message = (
            "The fields below contain the parameters used in the "
            "previous Standard Mapper round.\n"
            "You may change any value before running."
        )
    ...
    # ==================================================
    # 16. DYNAMICALLY SHOW/HIDE EPS AND MINIMUM SAMPLES
    # ==================================================
    ...
    # ==================================================
    # 17. AUTO-TUNING EXPLANATION
    # ==================================================

    explanation_frame = ttk.Frame(
        main_frame,
    )
    ...
    ttk.Label(
        explanation_frame,
        text=(
            "Epsilon and minimum samples are automatically "
            "calculated for each cover interval/cube."
        ),
        font=("TkDefaultFont", 11),
        wraplength=650,
        justify="left",
    ...
    ttk.Label(
        explanation_frame,
        text=(
            "Epsilon and minimum samples are required and "
    ...
    def run_with_parameters():
        ...
        # --------------------------------------------------
            ...
            # Actual epsilon and minimum samples are calculated
            # automatically for each cube.
            run_eps = None
    ...
    # ==================================================
    # 23. INITIAL AUTO-TUNING FIELD VISIBILITY
    # ==================================================

    # Previous auto-tuning selection determines whether
    # epsilon/minimum-samples fields initially appear.
    update_auto_tuning_fields()
...
def ask_after_round_window(
    ...
    instruction_label = ttk.Label(
        main_frame,
        text=(
            "Run Another Round lets you try different parameters "
            "without recalculating the persistence diagram.\n"
